...
private:
	...
	sf::Vector2f m_pos{ static_cast<float>(gWidth / 2), static_cast<float>(gHeight / 2) };  // Current velocity
	...
	void addNode(const sf::Vector2f pos, const sf::Color colour, const bool to_tail = true);
